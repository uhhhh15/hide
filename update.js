...
const MANIFEST_URL = `${REPO_ROOT}/public/scripts/extensions/third-party/hide/manifest.json`;
...
export async function performUpdate() {
    try {
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    if (m.display_name === "隐藏助手" ||
                        ...
                        ext.name === "hide") {
                        targetFolder = ext.name;
                        isGlobal = ext.type === 'global';
                        break;
                    }
                }
            } catch(e) {}
        ...
        // 后端 API 需要剥离 "third-party/" 前缀的短名称
