        ...
        <div class="inline-drawer">
            ...
            <div class="inline-drawer-content">
                ...
                <div class="hide-version-row">
                    <span>当前版本: <span id="hide-helper-current-version">加载中...</span><span id="hide-helper-new-badge" class="hide-new-badge" style="display: none;">NEW</span></span>
...
function setupEventListeners() {
    ...
    // --- 更新检测按钮事件 ---
    $(document).on('click', '#hide-helper-check-update-btn', async function() {
        const btn = $(this);
